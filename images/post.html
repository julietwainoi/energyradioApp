...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary ">
      ...
      <header id="header">
          <div class="container">
              <div class="row" style="height:50px;">
                  <div class="col-lg-10">
                     <h2> <i class="fa fa-cog"></i>  posts <small>manage blog posts</small></h2>  
                  </div>
                  <div class="col-lg-2">
      ...
      <div class="breadcrumb">
          <div class="container">
              <ol class="breadcrumb">
                <li href="admin.html"></li>
                <li style="margin-right:10px;">Dashboard</li> 
            ...
            <div class="col-lg-9"> 
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <h3 class="panel-title" style="background-color:#ff0000;">posts</h3>
                    </div>
