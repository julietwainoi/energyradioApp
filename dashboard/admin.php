        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link " href="post.html">Post</a></li>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="well dash-box">
                            <h2><i class="fa fa-user"></i> 204</h2>
                            <h4>Users</h4>
                   ...
                   <div class="col-lg-3" style="float:left">
                        <div class="well dash-box">
                            <h2><i class="fa fa-list-alt"></i> 14</h2>
                            <h4>pages</h4>
                    ...
                    <div class="col-lg-3" style="float:left">
                        <div class="well dash-box">
                            <h2><i class="fa fa-pencil"></i> 13</h2>
                            <h4>posts</h4>
                    ...
                    <div class="col-lg-3" style="float:left">
                        <div class="well dash-box">
                            <h2><i class="fa fa-signal"></i> 30,204</h2>
                            <h4>visitors</h4>
